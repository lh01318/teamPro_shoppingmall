    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-6 mb-5">
          <img src="<%=request.getContextPath()%>/img/white/white2-detail1.jpg" alt="" class="product-detail border-bottom-0">
          <img src="<%=request.getContextPath()%>/img/white/white2-detail2.jpg" alt="" class="product-detail border-bottom-0">
          <img src="<%=request.getContextPath()%>/img/white/white2-detail3.jpg" alt="" class="product-detail">
        </div>
        <div class="col-6">
