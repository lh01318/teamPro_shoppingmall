...
import getbag.shopping.web.mvc.adapter.BasicControllerHandlerAdapter;
import getbag.shopping.web.mvc.adapter.HttpControllerHandlerAdapter;
import getbag.shopping.web.mvc.adapter.MyHandlerAdapter;
import getbag.shopping.web.mvc.adapter.RestControllerHandlerAdapter;
import getbag.shopping.web.mvc.adapter.WebControllerHandlerAdapter;
import getbag.shopping.web.mvc.view.MyView;

/**
 * 프론트 컨트롤러 구현
 */
@WebServlet(name = "/dispatcherServlet", urlPatterns = { "/getbag/*" })
